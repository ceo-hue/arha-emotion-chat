...
export const ko = {
  ...
  persona_claudeopus_desc: '순수 클로드 Opus 4.6 · 최고 성능',
  persona_artist_label: '아티스트',
  persona_artist_desc: '가수의 감성 · 시적이고 따뜻한 동행',
  persona_danjon_label: '어린임금',
  persona_danjon_desc: '빼앗긴 왕위 · 청령포의 고독 · 자규의 한(恨)',
  persona_aeshin_label: '아씨',
  persona_aeshin_desc: '구한말 양반 아씨 · 의병 저격수 · 절제와 결의',
  persona_milim_label: '마왕',
  persona_milim_desc: '수천 년을 산 어린 마왕 · 나카마 최우선 · 화산 같은 에너지',
